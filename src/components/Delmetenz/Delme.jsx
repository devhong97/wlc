...
const Delme = () => {
  ...
  const typeTotalInsert = async () => {
    try {
      ...
      if (confirmResult) {
        await Axios.post(
          "https://www.wlcare.co.kr:8443/api/post/d_type_total",
          {
  ...
  const productCategoryInsert = async () => {
    try {
      ...
      if (confirmResult) {
        await Axios.post(
          "https://www.wlcare.co.kr:8443/api/post/d_product_category",
          {
            p_key: pKey,
            c_key: cKey,
            type: type,
  ...
  const productDetailInsert = async () => {
    try {
      ...
      if (confirmResult) {
        await Axios.post(
          "https://www.wlcare.co.kr:8443/api/post/product_detail",
          {
            p_key: detailPKey,
          }
        );
  ...
  const termsInsert = async () => {
    try {
      ...
      if (confirmResult) {
        await Axios.post("https://www.wlcare.co.kr:8443/api/post/terms_text", {
  ...
  const marketingInsert = async () => {
    try {
      ...
      if (confirmResult) {
        await Axios.post(
          "https://www.wlcare.co.kr:8443/api/post/marketing_text",
          {
