...
const CustomerList = () => {
    ...
    const columns = [
        ...
        { field: 'product', headerName: '상품명', minWidth: 200 },
        { field: 'hospital', headerName: '병원', minWidth: 200 },
        { field: 'hope_date_1', headerName: '희망일1' },
        { field: 'hope_date_2', headerName: '희망일2' },
        { field: 'result_date', headerName: '확정일' },
        { field: 'status', headerName: '검진유무', maxWidth: 100 },
        { field: 'pay_status', headerName: '입금여부', maxWidth: 100 },
        { field: 'hope_status', headerName: '상담희망', maxWidth: 100 },
        {
            field: 'send', headerName: '문자전송', type: 'actions',
            renderCell: (params) => (
    ...
    const rows = [
        {
            ...
            product: "vip상품", hospital: "천안병원dddddddddd", hope_date_1: "24.03.05", hope_date_2: "24.03.06",
