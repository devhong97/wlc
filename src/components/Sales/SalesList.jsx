...
const SalesList = () => {
  ...
  const getSalesData = async () => {
    try {
      const response = await Axios.get(
        "http://118.67.134.86:3001/api/get/sales_list",
        {
          params: {
  ...
  const getSalesTop = async (arrayData) => {
    try {
      const response = await Axios.get(
        "http://118.67.134.86:3001/api/get/sales_top",
        {
          params: {
            uid: decodeS1(), // uid를 params에 전달
          },
  ...
  const tab1Total = async () => {
    try {
      const response = await Axios.get(
        "http://118.67.134.86:3001/api/get/tab1Total",
        {
          params: {
  ...
  const tab1DateTotal = async () => {
    try {
      const response = await Axios.get(
        "http://118.67.134.86:3001/api/get/tab1dateTotal",
        {
          params: {
            choiceDate: result_date,
            tab: tab,
