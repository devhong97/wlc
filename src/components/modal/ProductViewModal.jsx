...
const ProductViewModal = (props) => {
  ...
  useEffect(() => {
    Axios.get("http://192.168.45.226:3001/api/get/categories")
      .then((response) => {
  ...
  useEffect(() => {
    if (selectedCategory !== "") {
      Axios.get(`http://192.168.45.226:3001/api/get/products/${selectedCategory}`)
        .then((response) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await Axios.post(
        "http://192.168.45.226:3001/api/post/product_modify",
        {
  ...
  const deleteProduct = async () => {
    ...
    try {
      const response = await Axios.post(
        "http://192.168.45.226:3001/api/post/product_delete",
        {
          idx: props.detailData.idx,
        }
      );
