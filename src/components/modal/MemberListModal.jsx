...
const MemberListModal = (props) => {
  ...
  const searchBoard = async () => {
    try {
      const response = await Axios.post(
        "http://118.67.134.86:3001/api/post/search_user_account",
        {
  ...
  const getMember = async () => {
    try {
      const response = await Axios.get(
        "http://118.67.134.86:3001/api/get/branch_manager_list",
        {
          params: {
  ...
  const selectRow = async (data) => {
    ...
    try {
      await Axios.put("http://118.67.134.86:3001/api/update/user_grade", {
